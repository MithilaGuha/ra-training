...
Note that you can create `Output` and `Readings` folders in your local clone without worrying about them being pushed. We can modify the `.gitignore` file to add other folders and files that aren't pushed to GitHub.
